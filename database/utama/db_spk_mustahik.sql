...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2023 at 02:07 AM
...
ALTER TABLE `tb_mustahik`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_kecamatan` (`id_kecamatan`,`id_desa`),
...
--
-- Constraints for table `tb_mustahik`
--
ALTER TABLE `tb_mustahik`
  ADD CONSTRAINT `tb_mustahik_ibfk_1` FOREIGN KEY (`id_desa`) REFERENCES `tb_desa` (`id_desa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_mustahik_ibfk_2` FOREIGN KEY (`id_kecamatan`) REFERENCES `tb_kecamatan` (`id_kecamatan`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
