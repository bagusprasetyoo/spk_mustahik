...
<?php foreach ($all_mustahik as $dt_mustahik) { ?>
    <div class="modal fade" id="cln_mustahik<?= $dt_mustahik->nik; ?>" tabindex="-1" aria-hidden="true">
...
<!-- End Modal -->
<!-- Modal -->
<div class="modal fade" id="edit_cln_mustahik" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <table class="table table-sm">
                            <tbody class="table-border-bottom-0">
                                <tr>
                                    <th>Anggota Keluarga melaksanakan ibadah sesuai syariat Islam</th>
                                    <td><?= $dt_mustahik->keluarga_beribadah ?></td>
                                </tr>
                                <tr>
                                    <th>Seluruh anggota keluarga sudah dapat makan minimal dua kali sehari</th>
                                    <td><?= $dt_mustahik->keluarga_jumlah_makan ?></td>
                                </tr>
                                <tr>
                                    <th>Seluruh anggota keluarga sudah memiliki pakaian berbeda untuk di rumah, tempat bekerja, sekolah dan bepergian</th>
                                    <td><?= $dt_mustahik->pakaian_layak ?></td>
                                </tr>
                                <tr>
                                    <th>Bila anak sakit, sudah dibawa ke sarana kesehatan</th>
                                    <td><?= $dt_mustahik->sarana_kesehatan ?></td>
                                </tr>
                                <tr>
                                    <th>Siap bekerja keras dan cerdas dan melaksanakan ibadah dengan ikhlas</th>
                                    <td><?= $dt_mustahik->siap_kerja ?></td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-bs-target="#tesModal" data-bs-toggle="modal">Save changes</button>
            </div>
        </div>
    </div>
</div>
