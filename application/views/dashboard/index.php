        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-success">Selamat Datang di Sistem Pendukung Keputusan Penentuan Penerima Zakat Produktif</h5>
                            <p class="mb-4">
                                Sistem ini dibangun untuk memudahkan penentuan penerima zakat produktif atau mustahik.
                ...
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="<?= base_url(); ?>/assets/img/icons/unicons/dashboard1.png" alt="chart success" class="rounded" />
                        </div>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                <a class="dropdown-item" href="<?= base_url('calonmustahik'); ?>">View More</a>
                            </div>
                        </div>
                    </div>
                    <span class="fw-medium d-block mb-1">Jumlah Calon Mustahik</span>
                    <h3 class="card-title mb-2"><?= $this->mylib->count_data('tb_mustahik'); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 col-12 mb-4">
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="<?= base_url(); ?>/assets/img/icons/unicons/dashboard2.png" alt="Credit Card" class="rounded" />
                        </div>
                        <div class="dropdown">
                    ...
                    <span>Jumlah Mustahik Diterima</span>
        ...
        <div class="col-lg-3 col-md-6 col-12 mb-4">
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="<?= base_url(); ?>/assets/img/icons/unicons/dashboard3.png" alt="Credit Card" class="rounded" />
                        </div>
                        <div class="dropdown">
                    ...
                    <span class="d-block mb-1">Jumlah Mustahik Ditolak</span>
        ...
        <div class="col-lg-3 col-md-6  col-12 mb-4">
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="<?= base_url(); ?>/assets/img/icons/unicons/dashboard4.png" alt="Credit Card" class="rounded" />
                        </div>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="cardOpt1">
                                <a class="dropdown-item" href="<?= base_url('pengguna'); ?>">View More</a>
                            </div>
                        </div>
                    </div>
                    <span class="fw-medium d-block mb-1">Jumlah Pengguna</span>
                    <h3 class="card-title mb-2"><?= $this->mylib->count_data('tb_pengguna'); ?></h3>
