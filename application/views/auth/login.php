...
<head>
    ...
    <title>SPK Mustahik - Login</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/jpg" href="<?= base_url(); ?>/assets/img/favicon/BAZNAS.jpg" />
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="<?= base_url(); ?>/assets/img/logo/BAZNAS.png" alt="" width="100px">
                                </span>
                                <!-- <span class="app-brand-text demo text-body fw-bold">SPKPZP</span> -->
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Hai selamat datang👋</h4>
                        <p class="mb-4">Silahkan login untuk memasuki sistem</p>

                        <?php $this->view('layouts/alert'); ?>

                        <form class="mb-3" action="<?= base_url('authcontroller/login') ?>" method="POST">
                            <div class="mb-3">
